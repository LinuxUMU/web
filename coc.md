...
# Código de Conducta de LinuxUMU
...
crear un ambiente constructivo cumpliendo las expectativas de esta comunidad.

Teniendo esto en cuenta, nos comprometemos a acogernos a ciertos valores comunes
de la comunidad, para comportarnos con la consideración y decoro necesarias para
una actividad positiva en la comunidad, incluyendo:

 1. Respetar el propósito de la comunidad
 2. Expresarse amable y honestamente
 3. Respetar opiniones y puntos de vista siempre que estas sean desde el respeto
...
Con el ánimo de mantener una comunidad segura y acogedora, también es necesario
...
Pueden ocurrir tensiones y conflictos a pesar de que cada miembro tenga la mejor
intención de colaborar.
No todos los conflictos son violaciones de este Código de Conducta, aunque este
Código apunta a evitar conflicto y minimizar el daño.

Cuando un incidente ocurre, es importante avisar a una persona responsable de la
comunidad cuanto antes, para mediar y tomar las medidas necesarias para mantener
el buen sentimiento de cooperación de la comunidad.

Para reportar problemas, avisar a un administrador del chat de Telegram, o
enviar un correo a la dirección de la comunidad.

## Abordar y reparar daño
...
### 1. Advertencia
 ...
 - Evento: Violación única o limitadamente repetida de un incidente de gravedad relativamente baja.
 - Consecuencia: Comunicación privada de advertencia por parte de los responsables de la comunidad.
 - Reparación: Ejemplos incluyen: disculpa privada por escrito directa o a través de los responsables. Reconocimiento de perpetración y clarificación de los hechos.
...
### 2. Actividades limitadas temporalmente
 ...
 - Reparación: Si el perpetrador tiene intenciones de cooperar y reincorporarse,
   se disculpará formalmente y usará el periodo de pausa para reflexionar sobre
   sus acciones y su impacto, y mantener un comportamiento ejemplar para su reincorporación en el futuro.
...
### 3. Suspensión temporal
 ...
 - Reparación: Cumplir con las condiciones de la suspensión, respetar su espíritu y
   pensar sobre como ser un integrante ejemplar para poder volver a las actividades.

### 4. Expulsión permanente

 - Evento: Un patrón de infracciones que otras medidas no han resuelto, o una infracción
   lo suficientemente grave que los responsables determinan que no hay manera de mantener
...
comentarios, commits, código, edits de la Wiki, issues, mensajes en canales, actividades, material o otras contribuciones
que no se alineen con este código de conducta, y comunicarán las razones de esta medida
cuando sea apropiado.

## Alcance

Este código aplica a todos los espacios de la comunidad, y también cuando miembros
de la comunidad representan a esta en espacios públicos o ajenos, incluyendo correo,
redes sociales, o representaciones, en linea o presencial.

Infracciones graves de normas culturales como manifestaciones de intolerancia, acoso,
